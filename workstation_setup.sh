...
git clone -b noetic_devel https://github.com/RethinkRobotics/sawyer_simulator.git
git clone -b melodic-devel https://github.com/RethinkRobotics-opensource/sns_ik.git

cd sawyer_simulator
git apply $SCRIPT_DIR/sawyer_simulator.patch
cd ..
...
echo "source $ROS_SAWYER_DIR/ros_ws/devel/setup.bash" >> /home/$(whoami)/.bashrc
